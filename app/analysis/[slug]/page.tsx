...
import { analysisData, resolve, categoryLabels } from "@/lib/analysis-data"
...
export default function AnalysisDetailPage({
  ...
  const { lang } = useLang()
  const post = analysisData.find((p) => p.slug === slug)
    ...
    <main>
      ...
      <article className="bg-background pb-28 pt-28">
        <div className="mx-auto max-w-[760px] px-6">
          ...
          {/* 2. Main Title - Strong clean white, high hierarchy */}
          ...
          {/* 5. Executive Summary / Tactical Conclusion Block */}
          ...
          {/* 6. Cover Image - Premium framed container */}
